...
**More detail:** See the [User Guide](User-Guide) for step-by-step guidance on using the symptom library.
...
**More detail:** See the [Admin Guide](Admin-Guide#practice-handbook) for how Practice Handbook works.
...
**More detail:** See [AI Features](AI-Features) for how AI tools work and their safety safeguards.
...
**More detail:** See [High-Risk & Highlighting](High-Risk-&-Highlighting) for how the highlighting system works.
...
**More detail:** See [Appointment Directory](Appointment-Directory) and [Workflow Guidance](Workflow-Guidance) for full details.
...
**More detail:** See the [User Guide](User-Guide) for more tips on safe navigation and getting help.
...
For more on how the toolkit supports safety and governance, see [Clinical Governance](Clinical-Governance).
