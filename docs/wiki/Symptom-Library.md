...
See the [High-Risk & Highlighting](High-Risk-&-Highlighting) page for more details.
...
All symptoms must pass clinical review before being fully available. See the [Clinical Governance](Clinical-Governance) page for details on the approval workflow.
...
- [Clinical Governance](Clinical-Governance) — How symptoms are reviewed and approved
- [High-Risk & Highlighting](High-Risk-&-Highlighting) — Highlight rules and visual indicators
- [AI Features](AI-Features) — AI tools for improving symptom instructions
