...
Superusers manage every account in the system from the Global Users page (Admin → Users). The page shows
at-a-glance stats (total users, system admins, active in the last 30 days, never signed in), sortable
name and last-active columns, and filters for system admins, test users, users with no surgery, and
inactivity. Search matches names, emails and surgery names. Selecting a user opens a detail panel where
superusers can edit their details, manage surgery memberships and roles, reset their password, or delete
the account.
...
|----------|---------|-------------|
| `ai_instructions` | AI Instruction Editor | Allow staff to generate and improve signposting instructions with AI |
| `ai_training` | AI Suggested Questions | Show AI-generated, patient-friendly questions on symptom pages to help staff gather the right information |
| `ai_surgery_customisation` | AI Surgery Customisation | Batch AI rewriting of symptom instructions based on the surgery onboarding profile |
...
- [Clinical Governance](/governance/clinical-governance) — How roles affect review workflow
- [Developer Guide](/technical/developer-guide) — Technical RBAC implementation
- [Symptom Library](/features/symptom-library) — How permissions affect symptom access
