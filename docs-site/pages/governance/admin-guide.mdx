...
In superuser surgery dropdowns — the "You're viewing" selector in the header, plus the surgery pickers on the symptom library, clinical review, feature flags, module access, practice settings and engagement analytics screens — test and template surgeries are grouped under a separate **Test & templates** section below the live surgeries, so live practices stay easy to find.
