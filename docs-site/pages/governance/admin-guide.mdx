...
Image icons are visual indicators that appear on symptom cards when their brief instruction contains a matching phrase. They provide quick visual context (e.g. a pharmacy icon for pharmacy-related symptoms).

- Superusers create and manage icons globally (upload image, set matching phrase, configure display sizes for cards and instruction pages, add alt text for accessibility).
- Surgery admins can toggle individual icons on or off for their surgery.
...
Admins can review suggestions from the Admin Dashboard:

- View all suggestions for the surgery.
- Delete individual suggestions or clear all at once.

Superusers can see suggestions across all surgeries.
