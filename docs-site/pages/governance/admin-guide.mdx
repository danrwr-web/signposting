...
In the superuser surgery dropdown (the "You're viewing" selector in the header), test and template surgeries are grouped under a separate **Test & templates** section below the live surgeries, so live practices stay easy to find.
