...
Smart visuals turn a [Practice Handbook](/features/practice-handbook) page into a scannable, infographic-style view built from a fixed set of layouts: summaries, warning callouts, numbered steps, checklists, contact cards, buddy-pair mappings, role cards, key-fact tiles, grouped bullets and small tables.
