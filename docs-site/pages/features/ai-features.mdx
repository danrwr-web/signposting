...
5. **Staleness protection** — The page content remains the source of truth. If it is edited after the visual was generated, the visual is flagged as out of date and the standard view becomes the default until it is regenerated.
