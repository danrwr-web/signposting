...
- **Refine with guidance** — type a short instruction such as "group by site" or "make the warning more prominent" and regenerate; the AI applies your steer within the same fixed layout rules
