...
A smart visual is a presentation of the page — the normal page content remains the single source of truth, and editing an item never changes its visual (or vice versa). If the underlying content is edited after a visual was generated, the visual is automatically flagged as **out of date**: staff see a warning banner and the standard view becomes the default again until an editor regenerates the visual. Saving and removing visuals is recorded in the [audit trail](#audit-trail).
