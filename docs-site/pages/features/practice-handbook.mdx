...
- **Anyone reading the page can click an image to view it full-screen**, which is useful when a floor plan or annotated screenshot is too detailed to read at page size. Press `Esc`, click the background, or use the close button to return to the page.
