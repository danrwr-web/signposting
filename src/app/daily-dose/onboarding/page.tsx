...
import DailyDoseOnboardingClient from './DailyDoseOnboardingClient'
...
export default async function DailyDoseOnboardingPage({ searchParams }: OnboardingPageProps) {
  ...
  return <DailyDoseOnboardingClient surgeryId={surgeryId} />
}
