...
export default function SurgeryDashboardClient({ surgery, user, setupComplete, pendingClinicalReviewCount }: SurgeryDashboardClientProps) {
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <ClinicalReviewNotice pendingCount={pendingClinicalReviewCount} surgeryName={surgery.name} />
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-3 mb-8">
          <Link href={`/s/${surgery.id}/signposting`} className="block h-full">
            <Card hoverable padding="lg" className="h-full overflow-hidden">
              <div className="flex items-center">
                <div className="flex-shrink-0">
          ...
          {canManageSurgery && (
            <>
              <Link href={`/s/${surgery.id}/admin/users`} className="block h-full">
                <Card hoverable padding="lg" className="h-full overflow-hidden">
                  <div className="flex items-center">
                    <div className="flex-shrink-0">
              ...
              <Link href={`/s/${surgery.id}/clinical-review`} className="block h-full">
                <Card hoverable padding="lg" className="h-full overflow-hidden">
                  <div className="flex items-center">
                    <div className="flex-shrink-0">
