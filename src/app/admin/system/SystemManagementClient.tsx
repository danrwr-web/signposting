...
export default function SystemManagementClient({
  ...
  const cards: ManagementCard[] = [
    ...
    },
    {
      ...
      description: 'Review feature requests, improvement ideas, and bug reports submitted by users across all surgeries, set their status, and respond.',
      href: '/admin/system/suggestions',
      stats: pendingSuggestionCount > 0
    ...
    },
    {
      ...
      description: 'Manage the sales pipeline, generate practice documents, and provision new surgeries.',
      href: '/super/pipeline',
      icon: (
        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6">
