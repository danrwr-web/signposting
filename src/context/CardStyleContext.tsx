...
const LEGACY_HIGH_RISK_SPLIT_STORAGE_KEY = 'signposting-high-risk-style-split'
const LEGACY_HIGH_RISK_CLASSIC_STORAGE_KEY = 'signposting-high-risk-style-classic'
