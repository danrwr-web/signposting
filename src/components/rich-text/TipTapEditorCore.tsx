 ...
 * Handles the actual TipTap editor implementation
 */
...
// NHS colour palette
const NHS_COLORS = [
  { name: 'Blue', value: '#005EB8', class: 'text-nhs-blue' },
  { name: 'Red', value: '#DA020E', class: 'text-red-600' },
  { name: 'Orange', value: '#F59E0B', class: 'text-orange-500' },
