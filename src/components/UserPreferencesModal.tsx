  ...
  return createPortal(
    ...
    >
      <div
        ...
        className="relative top-16 mx-auto w-full max-w-xl rounded-lg bg-white p-6 shadow-xl focus:outline-none"
      >
        ...
        <div className="mt-6 space-y-8">
          <section>
            ...
            <p className="mt-1 text-sm text-slate-600">
              Choose how symptom cards are displayed on the main page.
            </p>
